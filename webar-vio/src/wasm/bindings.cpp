...
void feedFrame(uintptr_t imgPtr, double timestamp) {
  // imgPtr points to Uint8ClampedArray (grayscale or RGBA)
  g_sys->ProcessFrame(reinterpret_cast<uint8_t*>(imgPtr), timestamp);
}
