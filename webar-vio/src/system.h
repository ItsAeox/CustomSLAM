...
private:
  ...
  int   targetKps_      = 220;      // feature budget at processing scale ***** Scale UP
  ...
  // Gravity direction estimate in world (unit vector), Y-positive is downward.
  cv::Vec3d gDirW_ = cv::Vec3d(0, 1, 0);
  double    gMag_  = 9.81;
